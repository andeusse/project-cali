...
export const SOLAR_WIND_DIAGRAM_VARIABLES: DiagramVariableType[] = [
  ...
  },
  {
    ...
    variable: 'cdteModuleTemperature',
    unit: '°C',
    isShown: true,
    diagramName: 'Temperatura Telururo de Cadmio',
    fixed: 1,
    x: 0,
    y: 0,
  },
  ...
  },
  {
    ...
    variable: 'flexiModuleTemperature',
    unit: '°C',
    isShown: true,
    diagramName: 'Temperatura flexible',
    fixed: 1,
    x: 0,
    y: 0,
  },
  ...
  },
  {
    ...
    variable: 'monoModuleTemperature',
    unit: '°C',
    isShown: true,
    diagramName: 'Temperatura monocristalino',
    fixed: 1,
    x: 0,
    y: 0,
  },
  {
    ...
    variable: 'polyModuleTemperature',
    unit: '°C',
    isShown: true,
    diagramName: 'Temperatura policristalino',
    fixed: 1,
    x: 0,
    y: 0,
  },
