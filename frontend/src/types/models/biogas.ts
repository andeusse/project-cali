...
export const BIOGAS: BiogasParameters = {
  ...
  adsorbentWeightTower1: {
    ...
    unit: 'g',
    variableString: 'Peso absorción 1',
    min: 0,
    max: 50000,
  },
  lengthTower1: {
  ...
  adsorbentWeightTower2: {
    disabled: false,
    value: 5000,
    tooltip: 'Peso de absorción torre 2',
    unit: 'g',
    variableString: 'Peso absorción 2',
    min: 0,
    max: 50000,
  },
  lengthTower2: {
  ...
  adsorbentWeightTower3: {
    disabled: false,
    value: 5000,
    tooltip: 'Peso de absorción torre 3',
    unit: 'g',
    variableString: 'Peso absorción 3',
    min: 0,
    max: 50000,
  },
  lengthTower3: {
