  ...
  def post(self):
    ...
    if (Online == True and OfflineEntranceVariables == False):  #Modo On and variables from plant
      ...
      if user not in biogas_instances:
        biogas_instances[user] = TrainingModel.TrainingBiogasPlant(t_train = t_train, ST_ini_R101 = ST_ini_R101, SV_ini_R101 = SV_ini_R101, Cc_R101 = Cc_ini_R101, Ch_R101 = Ch_ini_R101, Co_R101=Co_ini_R101, Cn_R101=Cn_ini_R101, Cs_R101=Cs_ini_R101, rho_R101=rho_ini_R101, Volume_V101 = Volume_V101,  
      ...
      if Model == "Arrhenius":
        biogas_plant.OptimizationArrhenius(resolution = 100)
        ...
        if (biogas_plant.Operation_mode == 3 or biogas_plant.Operation_mode == 4 or biogas_plant.Operation_mode == 5):
          biogas_output["K_R102"] = biogas_plant.K_mean_R101
          biogas_output["Ea_R102"] = biogas_plant.Ea_mean_R101
      if Model == "ADM1":
        biogas_plant.OptimizationADM1(resolution = 100)
        biogas_output["K_R101"] = biogas_plant.K_mean_R101
        if (biogas_plant.Operation_mode == 3 or biogas_plant.Operation_mode == 4 or biogas_plant.Operation_mode == 5):
          biogas_output["K_R102"] = biogas_plant.K_mean_R101
      if Model == "Gompertz":
        biogas_plant.OptimizationGompertz(resolution = 100)
        biogas_output["K_R101"] = biogas_plant.ym_R101
        biogas_output["Ea_R101"] = biogas_plant.U_R101
        biogas_plant["Lambda_R101"] = biogas_plant.L_R101
        if (biogas_plant.Operation_mode == 3 or biogas_plant.Operation_mode == 4 or biogas_plant.Operation_mode == 5):
          biogas_output["K_R102"] = biogas_plant.ym_R102
          biogas_output["Ea_R102"] = biogas_plant.U_R102
          biogas_plant["Lambda_R102"] = biogas_plant.L_R102
      
      biogas_plant.V101()
      biogas_plant.V102()
      biogas_plant.V107()
      biogas_plant.biogas_treatment(resolution = 2)
      ...
      biogas_output["C_sv_R101"] = biogas_plant.Csus_SV_R01
      biogas_output["SV_R101"] = biogas_plant.SV_R101
      biogas_output["C_st_R101"] = biogas_plant.Csus_ST_R101
      biogas_output["ST_R101"] = biogas_plant.ST_R01
      ...
      biogas_output["StorageCH4_V101Volume"] = biogas_plant.VCH4_acum_V101*1000
      ...
      biogas_output["StorageCO2_V101Volume"] = biogas_plant.VCO2_acum_V101*1000
      ...
      biogas_output["StorageCH4_V102Volume"] = biogas_plant.VCH4_acum_V102*1000
      ...
      biogas_output["StorageCO2_V102Volume"] = biogas_plant.VCO2_acum_V102*1000
      ...
      biogas_output["StorageCH4_V107Volume"] = biogas_plant.VCH4_acum_V107*1000
      ...
      biogas_output["StorageCO2_V107Volume"] = biogas_plant.VCO2_acum_V107*1000
    ...
    if (Online == False and OfflineEntranceVariables == True):  #Modo Offline and variables from plant
      ...
      if OperationMode == "Modo1":
        ...
        biogas_output["StorageCH4_V101Volume"] = biogas_plant.Vol_acum_CH4
        biogas_output["StorageCH4_V101Concentration"] = biogas_plant.xCH4_V101*100
        biogas_output["StorageCH4_V101moles"] = biogas_plant.molCH4_acum_V101
        biogas_output["StorageCO2_V101Volume"] = biogas_plant.Vol_acum_CO2
        biogas_output["StorageCO2_V101Concentration"] = biogas_plant.xCO2_V101*100
        biogas_output["StorageCO2_V101moles"] = biogas_plant.molCO2_acum_V101
        biogas_output["StorageH2S_V101Volume"] = biogas_plant.Vol_acum_H2S
        ...
        biogas_output["StorageO2_V101Volume"] = biogas_plant.Vol_acum_O2
        biogas_output["StorageO2_V101Concentration"] = biogas_plant.xO2_V101*100
        biogas_output["StorageO2_V101moles"] = biogas_plant.molO2_acum_V101
        biogas_output["StorageH2_V101Volume"] = biogas_plant.Vol_acum_H2
        ...
        biogas_output["StorageNH3_V101Volume"] = biogas_plant.Vol_acum_NH3
        ...
        biogas_output["StorageCH4_V102Volume"] = biogas_plant.Vol_acum_CH4
        biogas_output["StorageCH4_V102Concentration"] = biogas_plant.xCH4_V102*100
        biogas_output["StorageCH4_V102moles"] = biogas_plant.molCH4_acum_V102
        biogas_output["StorageCO2_V102Volume"] = biogas_plant.Vol_acum_CO2
        biogas_output["StorageCO2_V102Concentration"] = biogas_plant.xCO2_V102*100
        biogas_output["StorageCO2_V102moles"] = biogas_plant.molCO2_acum_V102
        biogas_output["StorageH2S_V102Volume"] = biogas_plant.Vol_acum_H2S
        ...
        biogas_output["StorageO2_V102Volume"] = biogas_plant.Vol_acum_O2
        biogas_output["StorageO2_V102Concentration"] = biogas_plant.xO2_V102*100
        biogas_output["StorageO2_V102moles"] = biogas_plant.molO2_acum_V102
        biogas_output["StorageH2_V102Volume"] = biogas_plant.Vol_acum_H2
        ...
        biogas_output["StorageNH3_V102Volume"] = biogas_plant.Vol_acum_NH3
        ...
        biogas_output["StorageCH4_V107Volume"] = biogas_plant.Vol_acum_CH4
        biogas_output["StorageCH4_V107Concentration"] = biogas_plant.xCH4_V107*100
        biogas_output["StorageCH4_V107moles"] = biogas_plant.molCH4_acum_V107
        biogas_output["StorageCO2_V107Volume"] = biogas_plant.Vol_acum_CO2
        biogas_output["StorageCO2_V107Concentration"] = biogas_plant.xCO2_V107*100
        biogas_output["StorageCO2_V107moles"] = biogas_plant.molCO2_acum_V107
        biogas_output["StorageH2S_V107Volume"] = biogas_plant.Vol_acum_H2S
        ...
        biogas_output["StorageO2_V107Volume"] = biogas_plant.Vol_acum_O2
        biogas_output["StorageO2_V107Concentration"] = biogas_plant.xO2_V107*100
        biogas_output["StorageO2_V107moles"] = biogas_plant.molO2_acum_V107
        biogas_output["StorageH2_V107Volume"] = biogas_plant.Vol_acum_H2
        ...
        biogas_output["StorageNH3_V107Volume"] = biogas_plant.Vol_acum_NH3
