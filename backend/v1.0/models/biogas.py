...
class Biogas(Resource):
  def post(self):
    ...
    if biogas_input["inputDigitalTwin"] == True: # Modo Gemelo On
      ...
      Biogas_Plant.ReactorSimulation(Model = "Gompertz", A_R101=0.0036, B_R101 = 3.55E-15, C_R101 = -46656, A_R102=0.0036, B_R102=3.55E-15, C_R102=-46656)


      print(Biogas_Plant.Operation_Data)
      print(biogas_input["InitialTotalSolidsR101"])
      print("SV[g/L]", Biogas_Plant.SV_R101_gL)
      print("SV [%]",Biogas_Plant.SV_R101_p)
      print("ST[%]", Biogas_Plant.ST_R101)
      try : 
        print("ST_R102[%]", Biogas_Plant.ST_R102)
        print("SV_R102[%]", Biogas_Plant.SV_R102_p)
        print("SV_R102[g/L]", Biogas_Plant.SV_R102_gL)
