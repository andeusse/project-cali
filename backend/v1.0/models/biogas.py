...
class Biogas(Resource):
  def post(self):
    ...
    if biogas_input["inputDigitalTwin"] == True: # Modo Gemelo On
      ...
      Biogas_Plant.ReactorSimulation(Model = "Arrhenius", A_R101=100, B_R101 = 1000000, C_R101 = -46656, A_R102=0.0036, B_R102=2.55E-15, C_R102=-46656)


      print(Biogas_Plant.Operation_Data)
      print("SV[g/L]", Biogas_Plant.SV_ini_R101_gL)
      print("SV [%]",Biogas_Plant.SV_ini_R101_p)
      print("ST[%]", Biogas_Plant.ST_ini_R101_p)
