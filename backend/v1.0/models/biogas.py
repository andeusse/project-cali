...
class Biogas(Resource):
  ...
  def post(self):
    ...
    if (Online == True and OfflineEntranceVariables == False):  #Modo On and variables from plant
      ...
      #print(biogas_plant_online.TrainMode, flush=True)
      if Model == "Arrhenius":
        biogas_plant_online.OptimizationArrhenius(resolution = 5)
        biogas_output["K_R101"] = abs(float(biogas_plant_online.K_mean_R101/60))
        biogas_output["Ea_R101"] = abs(float(biogas_plant_online.Ea_mean_R101))
      if Model == "ADM1":
        biogas_plant_online.OptimizationADM1(resolution = 400)
        biogas_output["K_R101"] = abs(float(biogas_plant_online.K_ini_ADM1_R101/60))
      if Model == "Gompertz":
        biogas_plant_online.Optimization_Gompertz()
        biogas_output["K_R101"] = float(biogas_plant_online.ym_R101)
        biogas_output["Ea_R101"] = float(biogas_plant_online.U_R101)
        biogas_output["Lambda_R101"] = float(biogas_plant_online.L_R101)
      ...
      biogas_plant_online.exitVariablestoFrontEnd()          
      ...
      # TK-100
      biogas_output["n"] = float(biogas_plant_online.n)
      biogas_output["a"] = float(biogas_plant_online.a)
      biogas_output["b"] = float(biogas_plant_online.b)
      biogas_output["c"] = float(biogas_plant_online.c)
      ...
      biogas_output["C_sv_R101"] = float(biogas_plant_online.Csus_ini_SV_R101_gl)
      biogas_output["SV_R101"] = (biogas_plant_online.SV_ini_R101*100)
      biogas_output["C_st_R101"] = biogas_plant_online.Csus_ini_ST_R101_gl
      biogas_output["ST_R101"] = (biogas_plant_online.ST_ini_R101*100)
      biogas_output["Organic_Charge_R101"] = biogas_plant_online.OC_R101
      biogas_output["x_R101"] = biogas_plant_online.x_R101_e*100
      # P101
      biogas_output["Pump101Flow"] = biogas_plant_online.P101
      # P102
      biogas_output["Pump102Flow"] = biogas_plant_online.P102
      # V101
      biogas_output["AcumBiogasPressureV101"] = biogas_plant_online.Pacum_V101_e
      biogas_output["StorageBiogasPressureV101"] = biogas_plant_online.P_V101_e
      ...
      biogas_output["StorageCH4_V101Concentration"] = biogas_plant_online.xCH4_V101_e
      ...
      biogas_output["StorageCO2_V101Concentration"] = biogas_plant_online.xCO2_V101_e
      ...
      biogas_output["StorageH2S_V101Concentration"] = biogas_plant_online.xH2S_V101_e
      ...
      biogas_output["StorageO2_V101Concentration"] = biogas_plant_online.xO2_V101_e
      ...
      biogas_output["StorageH2_V101Concentration"] = biogas_plant_online.xH2_V101_e
      ...
      biogas_output["StorageNH3_V101Concentration"] = biogas_plant_online.xNH3_V101_e
      ...
      biogas_output["Relative_humidity_V101"] = biogas_plant_online.RH_V101_e
      biogas_output["StorageEnergy_V101"] = biogas_plant_online.Energy_V101/1000
      # V102
      biogas_output["AcumBiogasPressureV102"] = biogas_plant_online.Pacum_V102_e
      biogas_output["StorageBiogasPressureV102"] = biogas_plant_online.P_V102_e
      ...
      biogas_output["StorageCH4_V102Concentration"] = biogas_plant_online.xCH4_V102_e
      ...
      biogas_output["StorageCO2_V102Concentration"] = biogas_plant_online.xCO2_V102_e
      ...
      biogas_output["StorageH2S_V102Concentration"] = biogas_plant_online.xH2S_V102_e
      ...
      biogas_output["StorageO2_V102Concentration"] = biogas_plant_online.xO2_V102_e
      ...
      biogas_output["StorageH2_V102Concentration"] = biogas_plant_online.xH2_V102_e
      ...
      biogas_output["StorageNH3_V102Concentration"] = biogas_plant_online.xNH3_V102_e
      biogas_output["StorageNH3_V102moles"] = biogas_plant_online.mol_acum_NH3_V102
      biogas_output["moles_humidity_V102"] = biogas_plant_online.mol_acum_H2O_V102
      biogas_output["Relative_humidity_V102"] = biogas_plant_online.RH_V102_e
      biogas_output["StorageEnergy_V102"] = biogas_plant_online.Energy_V102/1000
      # V107
      biogas_output["AcumBiogasPressureV107"] = biogas_plant_online.Pacum_V107_e
      biogas_output["StorageBiogasPressureV107"] = biogas_plant_online.P_V107_e
      ...
      biogas_output["StorageCH4_V107Concentration"] = biogas_plant_online.xCH4_V107_e
      ...
      biogas_output["StorageCO2_V107Concentration"] = biogas_plant_online.xCO2_V107_e
      ...
      biogas_output["StorageH2S_V107Concentration"] = biogas_plant_online.xH2S_V107_e
      ...
      biogas_output["StorageO2_V107Concentration"] = biogas_plant_online.xO2_V107_e
      ...
      biogas_output["StorageH2_V107Concentration"] = biogas_plant_online.xH2_V107_e
      ...
      biogas_output["StorageNH3_V107Concentration"] = biogas_plant_online.xNH3_V107_e
      ...
      biogas_output["Relative_humidity_V107"] = biogas_plant_online.RH_V107_e
      biogas_output["StorageEnergy_V107"] = biogas_plant_online.Energy_V107/1000
      # # Treatment biogas
    ...
    #offline variables offline  
      ...
      if OperationMode == "Modo1":
        ...
        biogas_output["StorageEnergy_V101"] = biogas_plant.Energy_V101/1000
        # V102
        ...
        biogas_output["StorageEnergy_V102"] = biogas_plant.Energy_V102/1000
        # V107
        ...
        biogas_output["StorageEnergy_V107"] = biogas_plant.Energy_V107/1000
        #biogasTreatment
      ...
      Cs_ini_R102 = data["initialAnalysisConditionsR102"]["atomicSulfurSubstrateConcetration"]["value"]
      rho_ini_R102 = data["initialAnalysisConditionsR102"]["substrateDensity"]["value"]
      Temp_R102 = data["inputTemperatureR101"]["value"]

      #substrate conditions
      inputSubstrateConditions = data["inputSubstrateConditions"]
      Cc = data["inputElementalAnalysisCarbonContent"]["value"]
      Ch = data["inputElementalAnalysisHydrogenContent"]["value"]
      Co = data["inputElementalAnalysisOxygenContent"]["value"]
      Cn = data["inputElementalAnalysisNitrogenContent"]["value"]
      ...
      #pump 104 conditions
      inputPump104 = data["inputPump104"]
      TRH = data["inputPump104HydraulicRetentionTime"]["value"]
      FT_P104 = data["inputPump104StartsPerDay"]["value"]
      TTO_P104 = data["inputPump104StartTime"]["value"]

      #Pump 101 conditions
      inputPump101 = data["inputPump101"]
      FT_P101 = data["inputPump101StartsPerDay"]["value"]
      TTO_P101 = data["inputPump101StartTime"]["value"]
      Q_P101 = data["inputPump101Flow"]["value"]

      #Pump 102 conditions
      inputPump102 = data["inputPump102"]
      FT_P102 = data["inputPump102StartsPerDay"]["value"]
      TTO_P102 = data["inputPump102StartTime"]["value"]
      Q_P102 = data["inputPump102Flow"]["value"]

      #Mixer TK100
      inputMixTK100 = data["inputMixTK100"]
      FT_mixin_TK100 = data["inputStartsPerDayMixTK100"]["value"]
      TTO_mixing_TK100 = data["inputStartTimeMixTK100"]["value"]
      RPM_TK100 = data["inputSpeedMixTK100"]["value"]

      #Mixer R101
      inputMixR101 = data["inputMixR101"]
      FT_mixin_R101 = data["inputStartsPerDayMixR101"]["value"]
      TTO_mixing_R101 = data["inputStartTimeMixR101"]["value"]
      RPM_R101 = data["inputSpeedMixR101"]["value"]

      #Mixer R102
      inputMixR102 = data["inputMixR102"] 
      FT_mixin_R102 = data["inputStartsPerDayMixR102"]["value"]
      TTO_mixing_R102 = data["inputStartTimeMixR102"]["value"]
      RPM_R102 = data["inputSpeedMixR102"]["value"]

      #Temperature R101
      inputTemperatureR101 = data["inputTemperatureR101"]["disabled"]
      T_R101 = data["inputTemperatureR101"]["value"]

      #PH R101
      inputPH_R101 = data["inputPHR101"]["disabled"]
      pH_R101 = data["inputPHR101"]["value"]

      #Temperature R102
      inputTemperatureR102 = data["inputTemperatureR102"]["disabled"]
      T_R102 = data["inputTemperatureR101"]["value"]

      #PH R102
      inputPH_R102 = data["inputPHR102"]["disabled"]
      pH_R102 = data["inputPHR102"]["value"]
      ...
      if user not in biogas_instances_offline_online:
         biogas_instances_offline_online[user] = Off_On_Model_Simulation.Biogas_Plant_prediction(DB_IP = DB_IP, DB_Port = DB_Port, DB_Organization = DB_Organization, DB_Bucket = DB_Bucket, DB_Token = DB_Token,
                                                                                                 VR1 = VR1, VR2 = VR2, VG1=VG1, VG2 = VG2, VG3 = VG3, tp = tp,
                                                                                                 ST_R101 = ST_ini_R101, SV_R101 = SV_ini_R101, Cc_R101 = Cc_ini_R101, Ch_R101 = Ch_ini_R101, Co_R101 = Co_ini_R101, Cn_R101 = Cn_ini_R101, Cs_R101 = Cs_ini_R101, rho_R101 = rho_ini_R101,
                                                                                                 ST_R102 = ST_ini_R102, SV_R102 = SV_ini_R102, Cc_R102 = Cc_ini_R102, Ch_R102 = Ch_ini_R102, Co_R102 = Co_ini_R102, Cn_R102 = Cn_ini_R102, Cs_R102 = Cs_ini_R102, rho_R102 = rho_ini_R102,
                                                                                                 OperationMode = OperationMode, inputSubstrateConditions = inputSubstrateConditions, Cc = Cc, Ch = Ch, Co = Co, Cn = Cn, Cs = Cs, ST = ST, SV = SV, rho = rho)

      if OperationMode in ["Modo1", "Modo2"]:
        biogas_plant = biogas_instances_offline_online[user]
        biogas_plant.substrate_conditions(Cc = Cc, Ch = Ch, Co = Co, Cn = Cn, Cs = Cs, ST = ST, SV = SV, rho = rho, inputSubstrateConditions = inputSubstrateConditions)
        biogas_plant.Pump104(TRH = TRH, FT_P104 = FT_P104, TTO_P104 = TTO_P104, time_accelerator=time_accelator, inputPump104 = inputPump104)
        biogas_plant.Pump101(FT_P101=FT_P101, TTO_P101=TTO_P101, Q_P101=Q_P101, inputPump101=inputPump101)
        biogas_plant.Mixing_TK100(FT_mixin_TK100 = FT_mixin_TK100, TTO_mixing_TK100 = TTO_mixing_TK100, RPM_TK100 = RPM_TK100, inputMixTK100 = inputMixTK100)
        biogas_plant.Mixing_R101(FT_mixin_R101 = FT_mixin_R101, TTO_mixing_R101 = TTO_mixing_R101, RPM_R101 = RPM_R101, inputMixR101 = inputMixR101)
        if Model == "Arrhenius":
          biogas_plant.Reactor101Simulation_Arrhenius(Operation=1, VR=VR1, Qin_1=biogas_plant.Q_P104v, 
                                                    Csus_in1=biogas_plant.Csus_ini, K=K_R101, Ea = Ea_R101, T=T_R101, pH = pH_R101)
          biogas_output["K_R101"] = K_R101
          biogas_output["Ea_R101"] = Ea_R101
        elif Model == "ADM1":
          biogas_plant.Reactor101Simulation_ADM1(Operation=1, VR=VR1, Qin_1=biogas_plant.Q_P104v, 
                                                        Csus_in1=biogas_plant.Csus_ini, K=K_R101)
          biogas_output["K_R101"] = K_R101

        elif Model == "Gompertz":
          biogas_plant.Reactor101Simulation_Gompertz(Operation=1, ym=K_R101, U=Ea_R101, Lambda=L_R101,
                                                    Qin_1=biogas_plant.Q_P104v)
          biogas_output["K_R101"] = K_R101
          biogas_output["Ea_R101"] = Ea_R101
          biogas_output["Lambda_R101"] = L_R101
        
        biogas_plant.V101(Pset = Pset_V101)
        biogas_plant.V102mode1(Pset = Pset_V102)
        biogas_plant.V107mode1(Pset = Pset_V107)
        biogas_plant.biogas_treatment_model1(W_fe2O3=w_Fe, K_H2S=K_H2S, K_NH3=K_NH3, K_H2O=K_H2O, w_carbon=w_Carbon, w_silica=w_silica, qmax_H2O=qmax_H2O, qmax_H2S=qmax_H2S, qmax_NH3=qmax_NH3, k2_H2O = K2_H2O, k2_NH3 = K2_NH3, k2_H2S = K2_H2S)
        biogas_plant.time_counter()

        #Exit Variables Mode 1 and 2
        #TK100
        biogas_output["n"] = biogas_plant.n
        biogas_output["a"] = biogas_plant.a
        biogas_output["b"] = biogas_plant.b
        ...
        biogas_output["d"] = biogas_plant.d
        biogas_output["Mix_Velocity_TK100"] = biogas_plant.RPM_TK100
        biogas_output["C_sv"] = biogas_plant.Csv_sus                              #gSV/L
        biogas_output["SV"] = biogas_plant.SV*100
        biogas_output["C_st"] = biogas_plant.Cst_sus
        biogas_output["ST"] = biogas_plant.ST*100
        # P104
        biogas_output["Pump104Flow"] = biogas_plant.Q_P104_Lh
        #P101
        if OperationMode == "Modo2":
          biogas_output["Pump101Flow"] = biogas_plant.Q_P101
        else:
          biogas_output["Pump101Flow"] = 0
        
        # R101
        biogas_output["Mix_Velocity_R101"] = biogas_plant.RPM_R101
        
        if inputPH_R101 == True or inputTemperatureR101 == True:
          biogas_plant.getdata(T_R101 = T_R101, pH_R101 = pH_R101, T_R102 = T_R102, pH_R102 = pH_R102)
          if inputPH_R101 == True:
            biogas_output["pH_R101"] = biogas_plant.pH_R101
          else:
            biogas_output["pH_R101"] = pH_R101
        
          if inputTemperatureR101 == True:
        ...
        biogas_output["operationMode"] = f"Modo{int(biogas_plant.Operation_mode)}"
        biogas_output["C_sv_R101"] = biogas_plant.SV_R101_gl
        biogas_output["SV_R101"] = biogas_plant.SV_R101_p*100
        biogas_output["C_st_R101"] = biogas_plant.ST_R101_gl
        biogas_output["ST_R101"] = biogas_plant.ST_R101_p*100
        ...
        biogas_output["StorageCH4_V101Volume"] = biogas_plant.Vol_acum_CH4_V101
        biogas_output["StorageCH4_V101Concentration"] = biogas_plant.xCH4_V101*100
        biogas_output["StorageCH4_V101moles"] = biogas_plant.nCH4_V101_acum_i
        biogas_output["StorageCO2_V101Volume"] = biogas_plant.Vol_acum_CO2_V101
        biogas_output["StorageCO2_V101Concentration"] = biogas_plant.xCO2_V101*100
        biogas_output["StorageCO2_V101moles"] = biogas_plant.nCO2_V101_acum_i
        biogas_output["StorageH2S_V101Volume"] = biogas_plant.Vol_acum_H2S_V101
        biogas_output["StorageH2S_V101Concentration"] = biogas_plant.xH2S_V101*1000000
        biogas_output["StorageH2S_V101moles"] = biogas_plant.nH2S_V101_acum_i
        biogas_output["StorageO2_V101Volume"] = biogas_plant.Vol_acum_O2_V101
        biogas_output["StorageO2_V101Concentration"] = biogas_plant.xO2_V101*100
        biogas_output["StorageO2_V101moles"] = biogas_plant.nO2_V101_acum_i
        biogas_output["StorageH2_V101Volume"] = biogas_plant.Vol_acum_H2_V101
        biogas_output["StorageH2_V101Concentration"] = biogas_plant.xH2_V101*1000000
        biogas_output["StorageH2_V101moles"] = biogas_plant.nH2_V101_acum_i
        biogas_output["StorageNH3_V101Volume"] = biogas_plant.Vol_acum_NH3_V101
        biogas_output["StorageNH3_V101Concentration"] = biogas_plant.xNH3_V101*1000000
        biogas_output["StorageNH3_V101moles"] = biogas_plant.nNH3_V101_acum_i
        biogas_output["moles_humidity_V101"] = biogas_plant.nH2O_V101_acum_i
        biogas_output["Relative_humidity_V101"] = biogas_plant.RH_V101
        biogas_output["StorageEnergy_V101"] = biogas_plant.Energy_V101/1000
        # V102
        biogas_output["AcumBiogasPressureV102"] = biogas_plant.Pacum_V102
        ...
        biogas_output["StorageCH4_V102Volume"] = biogas_plant.Vol_acum_CH4_V102
        biogas_output["StorageCH4_V102Concentration"] = biogas_plant.xCH4_V102*100
        biogas_output["StorageCH4_V102moles"] = biogas_plant.nCH4_V102_acum_i
        biogas_output["StorageCO2_V102Volume"] = biogas_plant.Vol_acum_CO2_V102
        biogas_output["StorageCO2_V102Concentration"] = biogas_plant.xCO2_V102*100
        biogas_output["StorageCO2_V102moles"] = biogas_plant.nCO2_V102_acum_i
        biogas_output["StorageH2S_V102Volume"] = biogas_plant.Vol_acum_H2S_V102
        biogas_output["StorageH2S_V102Concentration"] = biogas_plant.xH2S_V102*1000000
        biogas_output["StorageH2S_V102moles"] = biogas_plant.nH2S_V102_acum_i
        biogas_output["StorageO2_V102Volume"] = biogas_plant.Vol_acum_O2_V102
        biogas_output["StorageO2_V102Concentration"] = biogas_plant.xO2_V102*100
        biogas_output["StorageO2_V102moles"] = biogas_plant.nO2_V102_acum_i
        biogas_output["StorageH2_V102Volume"] = biogas_plant.Vol_acum_H2_V102
        biogas_output["StorageH2_V102Concentration"] = biogas_plant.xH2_V102*1000000
        biogas_output["StorageH2_V102moles"] = biogas_plant.nH2_V102_acum_i
        biogas_output["StorageNH3_V102Volume"] = biogas_plant.Vol_acum_NH3_V102
        biogas_output["StorageNH3_V102Concentration"] = biogas_plant.xNH3_V102*1000000
        biogas_output["StorageNH3_V102moles"] = biogas_plant.nNH3_V102_acum_i
        biogas_output["moles_humidity_V102"] = biogas_plant.nH2O_V102_acum_i
        biogas_output["Relative_humidity_V102"] = biogas_plant.RH_V102
        biogas_output["StorageEnergy_V102"] = biogas_plant.Energy_V102/1000
        # V107
        biogas_output["AcumBiogasPressureV107"] = biogas_plant.Pacum_V107
        ...
        biogas_output["StorageCH4_V107Volume"] = biogas_plant.Vol_acum_CH4_V107
        biogas_output["StorageCH4_V107Concentration"] = biogas_plant.xCH4_V107*100
        biogas_output["StorageCH4_V107moles"] = biogas_plant.nCH4_V107_acum_i
        biogas_output["StorageCO2_V107Volume"] = biogas_plant.Vol_acum_CO2_V107
        biogas_output["StorageCO2_V107Concentration"] = biogas_plant.xCO2_V107*100
        biogas_output["StorageCO2_V107moles"] = biogas_plant.nCO2_V107_acum_i
        biogas_output["StorageH2S_V107Volume"] = biogas_plant.Vol_acum_H2S_V107
        biogas_output["StorageH2S_V107Concentration"] = biogas_plant.xH2S_V107*1000000
        biogas_output["StorageH2S_V107moles"] = biogas_plant.nH2S_V107_acum_i
        biogas_output["StorageO2_V107Volume"] = biogas_plant.Vol_acum_O2_V107
        biogas_output["StorageO2_V107Concentration"] = biogas_plant.xO2_V107*100
        biogas_output["StorageO2_V107moles"] = biogas_plant.nO2_V107_acum_i
        biogas_output["StorageH2_V107Volume"] = biogas_plant.Vol_acum_H2_V107
        biogas_output["StorageH2_V107Concentration"] = biogas_plant.xH2_V107*1000000
        biogas_output["StorageH2_V107moles"] = biogas_plant.nH2_V107_acum_i
        biogas_output["StorageNH3_V107Volume"] = biogas_plant.Vol_acum_NH3_V107
        biogas_output["StorageNH3_V107Concentration"] = biogas_plant.xNH3_V107*1000000
        biogas_output["StorageNH3_V107moles"] = biogas_plant.nNH3_V107_acum_i
        biogas_output["moles_humidity_V107"] = biogas_plant.nH2O_V107_acum_i
        biogas_output["Relative_humidity_V107"] = biogas_plant.RH_V107
        biogas_output["StorageEnergy_V107"] = biogas_plant.Energy_V107/1000
      ...
      elif OperationMode in ["Modo3", "Modo5"]:
        biogas_plant = biogas_instances_offline_online[user]
        biogas_plant.substrate_conditions(Cc = Cc, Ch = Ch, Co = Co, Cn = Cn, Cs = Cs, ST = ST, SV = SV, rho = rho, inputSubstrateConditions = inputSubstrateConditions)
        biogas_plant.Pump104(TRH = TRH, FT_P104 = FT_P104, TTO_P104 = TTO_P104, time_accelerator=time_accelator, inputPump104 = inputPump104)
        biogas_plant.Pump101(FT_P101=FT_P101, TTO_P101=TTO_P101, Q_P101=Q_P101, inputPump101=inputPump101)
        biogas_plant.Pump102(FT_P102=FT_P102, TTO_P102=TTO_P102, Q_P102=Q_P102, inputPump102=inputPump102)
        biogas_plant.Mixing_TK100(FT_mixin_TK100=FT_mixin_TK100, TTO_mixing_TK100=TTO_mixing_TK100, RPM_TK100=RPM_TK100, inputMixTK100=inputMixTK100)
        biogas_plant.Mixing_R101(FT_mixin_R101=FT_mixin_R101, TTO_mixing_R101=TTO_mixing_R101, RPM_R101=RPM_R101, inputMixR101=inputMixR101)
        biogas_plant.Mixing_R102(FT_mixin_R102=FT_mixin_R102, TTO_mixing_R102=TTO_mixing_R102, RPM_R102=RPM_R102, inputMixR102=inputMixR102)

        if Model == "Arrhenius":
          biogas_plant.Reactor101Simulation_Arrhenius(Operation=1, VR=VR1, Qin_1=biogas_plant.Q_P104v, 
                                                      Csus_in1=biogas_plant.Csus_ini, K=K_R101, Ea = Ea_R101, T=T_R101, pH = pH_R101)
          biogas_plant.Reactor102Simulation_Arrhenius(Operation=1,VR=VR2, Qin_1=biogas_plant.Q_P104v, Csus_in1=biogas_plant.Csus_ini_R101,
                                                      K = K_R102, Ea = Ea_R102, T = T_R102, pH = pH_R102)
          biogas_output["K_R101"] = K_R101
          biogas_output["Ea_R101"] = Ea_R101
        ...
        biogas_plant.V101(Pset = Pset_V101)
        biogas_plant.V102_model2(Pset = Pset_V102)
        biogas_plant.V107mode1(Pset = Pset_V107)
        biogas_plant.biogas_treatment_model1(W_fe2O3=w_Fe, K_H2S=K_H2S, K_NH3=K_NH3, K_H2O=K_H2O, w_carbon=w_Carbon, w_silica=w_silica, qmax_H2O=qmax_H2O, qmax_H2S=qmax_H2S, qmax_NH3=qmax_NH3, k2_H2O = K2_H2O, k2_NH3 = K2_NH3, k2_H2S = K2_H2S)
        biogas_plant.time_counter()

        #Exit Variables Mode 3 and 5
        #TK100
        biogas_output["n"] = biogas_plant.n
        biogas_output["a"] = biogas_plant.a
        biogas_output["b"] = biogas_plant.b
        ...
        if inputPH_R102 == True or inputTemperatureR102 == True:
          biogas_plant.getdata(T_R101 = T_R101, pH_R101 = pH_R101, T_R102 = T_R102, pH_R102 = pH_R102)
          if inputPH_R102 == True:
            biogas_output["pH_R102"] = biogas_plant.pH_R102
          else:
            biogas_output["pH_R102"] = pH_R102
        
          if inputTemperatureR102 == True:
            biogas_output["Temp_R102"] = biogas_plant.T_R102
          else:
            biogas_output["Temp_R102"] = Temp_R102
        else:
          biogas_output["pH_R102"] = pH_R102
          biogas_output["Temp_R102"] = Temp_R102
