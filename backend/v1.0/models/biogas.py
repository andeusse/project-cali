...
class Biogas(Resource):
  def post(self):
    ...
    if biogas_input["DigitalTwin"] == True: # Modo Gemelo On
      ...
      Biogas_Plant.Mixing_R102(FT_mixin_R102 = biogas_input["FT_mixing_R102"], TTO_mixing_R102=10, RPM_R102=50)
      ...
      Biogas_Plant.V101()
      Biogas_Plant.V102()
      Biogas_Plant.biogas_treatment(D1 = biogas_input["D1"], D2 = biogas_input["D2"], D3 = biogas_input["D3"], W1 = biogas_input["W1"], W2 = biogas_input["W2"], W3 = biogas_input["W3"],
                                    L1 = biogas_input["L1"], L2 = biogas_input["L2"], L3 = biogas_input["L3"])
      Biogas_Plant.V107()
