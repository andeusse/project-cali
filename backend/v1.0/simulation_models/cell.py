...
class TwinCell:
    ...
    def twinOutput(self, previousCellVoltage, inputCellTemperature, inputElectronicLoadCurrent, lightsPower, cellSelfFeedingPower, previousGeneratedEnergy, delta_t):
        ...
        return round(self.hydrogenFlow,2), round(self.cellCurrent,2), round(self.cellVoltage,2), round(self.cellPower,2), round(self.electronicLoadVoltage,2), round(self.electronicLoadCurrent,2), round(self.electronicLoadPower,2), round(self.cellEfficiency,1), round(self.cellGeneratedEnergy,2), round(self.n_converter), round(self.cellSelfFeedingPower,2), round(self.lightsPower,2)