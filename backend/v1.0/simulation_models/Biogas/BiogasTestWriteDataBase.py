...
while True:
    ...
    if iteration == 1:
        ...
        DB.InfluxDBwriter(measurement = "Planta_Biogas", device = "interfaz", variable = "MNS", value = 4, timestamp = timestamp1)
        ...
        DB.InfluxDBwriter(measurement = "Planta_Biogas", device = "interfaz", variable = "MP2", value = 4, timestamp = timestamp1)
