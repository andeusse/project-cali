...
class BiogasPlantSimulation:
    def __init__ (self, VR1=30, VR2=70, VG1=15, VG2=35, VG3=35, tp=30, 
        ...
        #gomperz
        self.mol_ini = (self.SV_R101/100)/(self.MW_sustrato_R101)*(self.rho_R101)*self.VR1
    ...
    def Reactor101Simulation_Gompertz (self, Operation, ym, U, Lambda, Qin_1, Qin_2 = [0]):
        ...
        self.Csus_ini_R101 = (self.mol_ini + mol_in - self.mol_sus_expended_R101 - mol_out)/self.VR1
        self.mol_ini = self.Csus_ini_R101 * self.VR1
    ...
    def V101_mode1 (self, Pset, Model):
        ...
        self.Vol_acum_CH4 = self.Vol_esp_CH4 * self.molCH4_acum_V101
        self.Vol_acum_CO2 = self.Vol_esp_CO2 * self.molCO2_acum_V101
        self.Vol_acum_O2 = self.Vol_esp_O2 * self.molO2_acum_V101
        self.Vol_acum_H2S = self.Vol_esp_H2S * self.molH2S_acum_V101
        self.Vol_acum_H2 = self.Vol_esp_H2 * self.molH2_acum_V101
        self.Vol_acum_NH3 = self.Vol_esp_NH3 * self.molNH3_acum_V101 
    ...
    def V102_mode1 (self, Pset):
        ...
        #Standard volume estimation for storage and accumulated biogas
        #Standard volume estimation for accumulated biogas
        self.Vacum_std_V102 = (self.Pacum_V102*self.VG2*self.Tstd)/(self.Pstd*self.Temperature)
        #Standard colume estimation for storage biogas
        self.Vstorage_std_V102 = (self.Pstorage_V102*self.VG2*self.Tstd)/(self.Pstd*self.Temperature)
        ...
        self.Vol_acum_CH4 = self.Vol_esp_CH4_V102 * self.molCH4_acum_V102
        self.Vol_acum_CO2 = self.Vol_esp_CO2_V102 * self.molCO2_acum_V102
        self.Vol_acum_O2 = self.Vol_esp_O2_V102 * self.molO2_acum_V102
        self.Vol_acum_H2S = self.Vol_esp_H2S_V102 * self.molH2S_acum_V102
        self.Vol_acum_H2 = self.Vol_esp_H2_V102 * self.molH2_acum_V102
        self.Vol_acum_NH3 = self.Vol_esp_NH3_V102 * self.molNH3_acum_V102 
        ...
        if self.Pstorage_V102 > Pset:
            ...
            biogasmol_storage_V101_pres = ((P_storage_V102_pres*6894.76) * ((self.VG2)/1000))/(8.314*(self.Temperature+273.15)) 

            self.mol_CH4_transferToV107 = (biogasmol_storage_V101_pres - self.biogasmol_storage_V102)*self.xCH4_V102_wet
            self.mol_CO2_transferToV107 = (biogasmol_storage_V101_pres - self.biogasmol_storage_V102)*self.xCO2_V102_wet
            self.mol_O2_transferToV107 = (biogasmol_storage_V101_pres - self.biogasmol_storage_V102)*self.xO2_V102_wet
            self.mol_H2S_transferToV107 = (biogasmol_storage_V101_pres - self.biogasmol_storage_V102)*self.xH2S_V102_wet
            self.mol_NH3_transferToV107 = (biogasmol_storage_V101_pres - self.biogasmol_storage_V102)*self.xNH3_V102_wet
            self.mol_H2O_transfertoV107 = (biogasmol_storage_V101_pres - self.biogasmol_storage_V102)*self.xH2O_V102_wet
            self.mol_H2_transfertoV107 = (biogasmol_storage_V101_pres - self.biogasmol_storage_V102)*self.xH2_V102_wet
    ...
    def V107_mode1(self, Pset, Pmin = 0):
        ...
        #Standard volume estimation for storage and accumulated biogas
        #Standard volume estimation for accumulated biogas
        self.Vacum_std_V107 = (self.Pacum_V107*self.VG3*self.Tstd)/(self.Pstd*self.Temperature)
        #Standard colume estimation for storage biogas
        self.Vstorage_std_V107 = (self.Pstorage_V107*self.VG3*self.Tstd)/(self.Pstd*self.Temperature)
        ...
        self.Vol_acum_CH4 = self.Vol_esp_CH4_V107 * self.molCH4_acum_V107
        self.Vol_acum_CO2 = self.Vol_esp_CO2_V107 * self.molCO2_acum_V107
        self.Vol_acum_O2 = self.Vol_esp_O2_V107 * self.molO2_acum_V107
        self.Vol_acum_H2S = self.Vol_esp_H2S_V107 * self.molH2S_acum_V107
        self.Vol_acum_H2 = self.Vol_esp_H2_V107 * self.molH2_acum_V107
        self.Vol_acum_NH3 = self.Vol_esp_NH3_V107 * self.molNH3_acum_V107
    ...
    def biogas_treatment_model1 (self, W_fe2O3, K_H2S, K_NH3, K_H2O, w_carbon = 1.0, w_silica = 1.0, qmax_H2S = 0.0188,
                                 qmax_NH3 = 0.1, qmax_H2O = 0.1): #w in grams, qmax = [mol/g]
        #-------H2S--------
        ...
        self.mol_H2S_transferToV107 = self.mol_H2S_ads_acum - self.mol_H2S_ads_acum_i 
        ...
        self.mol_NH3_transferToV107 = self.mol_NH3_ads_acum - self.mol_NH3_ads_acum_i
        ...
        self.mol_H2O_transfertoV107 = self.mol_H2O_ads_acum - self.mol_H2O_ads_acum_i
