    ...
    def ReactorSimulation(self, Model, A_R101, B_R101, C_R101, A_R102=1, B_R102=1, C_R102=1):
        ...
        if self.Model == "Arrhenius":
            ...
            if self.OperationMode in ["Modo1", "Modo2"] :
                ...
                self.mol_H2O_R102 = self.mol_H2O_R102 + abs(self.mol_CH4_stoichometric_R102*np.random.normal(0.01, 0.000001))
            ...
            self.mol_H2O_R101 = self.mol_H2O_R101 + abs(self.mol_CH4_stoichometric_R101*np.random.normal(0.01, 0.000001))
        ...
        # Model ADM1
            ...
            if self.OperationMode in ["Modo3", "Modo5"]:
                ...
                self.mol_H2O_R102 = self.mol_H2O_R102 + abs(self.mol_CH4_R102 - self.Operation_Data.mol_CH4_acum_R102 .iloc[-1] * np.random.normal(0.01, 0.000001))
